...
export default function ShinyPurse({width, height}) {
  return (
    <svg 
    ...
    >
      ...
      <circle cx="256" cy="256" r="256" fill="#f8e71c" opacity="1" stroke="#fff" strokeWidth="0">
      </circle>
      ...
      <g fontFamily="Arial, Helvetica, sans-serif" fontSize="120" fontStyle="normal" fontWeight="bold" textAnchor="middle" className="" transform="translate(256,300)">
        <text stroke="#000" strokeWidth="30" opacity="1">
        </text>
